...
public class TCPConnection : MonoBehaviour {
	...
	public string readSocket() {
		...
		/*if (theStream.DataAvailable) {
			...
			//Debug.Log("theStream: NotAvailable");
		*/
		if (!socketReady)
			return "!socketReady";
		//if (theStream.DataAvailable)
			return theReader.ReadLine();
		//return "!theStream.DataAvailable";
	}
